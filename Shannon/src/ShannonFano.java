...
public class ShannonFano {
	...
	public String toString() {
		String str = "";
		//str += "*** La probabilidad " + (probabilityIsGiven ? " " : " no ") + " es dada. "
		//		+ (probabilityIsGiven ? "No calculamos la probabilidad."
		//				: "La probabilidad se calculó usando la frecuencia de cada carácter en la Cadena dada.")
		//		+ "\n";
		str += "Cadena original: \"" + originalString + "\"\n";
		str += "------------------------------------------------------------------------\n";
		str += "Simbolo\t\tFrecuencia\tProbabilidad\tShannon-F \tASCII Code\n";
		str += "------------------------------------------------------------------------\n";
		...
		/*str += "------------------------------------------------------------------------\n";
		str += "Eficiencia antes de Compresion: " + 100 * (Math.round((entropy / averageLengthBefore) * 100.0) / 100.0)
				+ "%\n";
		str += "Eficiencia despues de Compresion: " + 100 * (Math.round((entropy / averageLengthAfter) * 100.0) / 100.0)
				+ "%\n";
		str += "------------------------------------------------------------------------\n";*/
		return str;
	}
